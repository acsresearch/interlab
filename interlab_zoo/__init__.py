...
(For example, an Actor using particular internal deliberation schema and prompts but being usable over
a range of scenarios is a good fit, while an actor tuned for a concrete game is better kept in your
experimental repo.)
"""
