...
def summarize_with_limit(
    text: str, model: Any, token_limit: int = 300, length_request: str = "100 words"
):
    ...
    If you change the token limit, you should also change the length request.
    Note that "100 words" usually produces a summary of 100-150 tokens with GPT-3.
    """
    if token_limit < 10:
